...
public class Autopath extends LinearOpMode {
    ...
    final double circumference = Math.PI * wheelDiameterInches;
    //needs testing
    ...
    final double countsPerInch = (ticksPerRev * gearReduction)/circumference;
    ...
    */
    public void spinDuck(double motorSpeed, double timeoutSeconds) {
        ...
        if (opModeIsActive()) {
            newCarouselTarget = robot.carouselWheel.getCurrentPosition() + (int) (carouselCircumference/circumference * ticksPerRev);
            ...
            while (opModeIsActive() && runtime.seconds() < timeoutSeconds && robot.carouselWheel.isBusy()) {
                telemetry.addData("Carousel spinning", "Running to %7d",
...
//    final double ticksPerRev = 537.6; //amount of ticks per revolution for *insert motor name*
//    public final int tileLength = 24; //each tile is 24 inches or 2 feet
//    public final double carouselCircumference = (Math.PI * 15) + 25; //carousel diameter is 15 inches, add 4 inches to push off duck
//
//    final double countsPerInch = (ticksPerRev * gearReduction)/circumference;
//
//    @Override
...
//            newCarouselTarget = (int)(carouselCircumference/circumference * ticksPerRev);
//            robot.carouselWheel.setTargetPosition(newCarouselTarget);
//            robot.carouselWheel.setMode(DcMotor.RunMode.RUN_TO_POSITION);
//            runtime.reset();
//            robot.carouselWheel.setPower(Math.abs(motorSpeed));
...
//            //update driver
//            while (opModeIsActive() && runtime.seconds() < timeoutSeconds && robot.carouselWheel.isBusy()) {
//                telemetry.addData("Carousel spinning", "%7d",
//                        robot.carouselWheel.getCurrentPosition());
//                telemetry.update();
//            }
//
